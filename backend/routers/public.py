...
def list_routes():
    return {
        ...
        "routes": [
            ...
            {"method": "PUT", "path": "/pda-admin/cc/persohub-sympos/{sympo_id}"},
            {"method": "DELETE", "path": "/pda-admin/cc/persohub-sympos/{sympo_id}"},
            {"method": "GET", "path": "/pda-admin/cc/options/persohub-events"},
            {"method": "PUT", "path": "/pda-admin/cc/persohub-events/{event_id}/sympo"},
            ...
            {"method": "GET", "path": "/pda-admin/superadmin/migration-status/persohub-event-namespace"},
            {"method": "GET", "path": "/pda-admin/superadmin/migrations/persohub-events-parity-status"},
            {"method": "POST", "path": "/pda-admin/superadmin/migrations/persohub-events-parity-flag"},
            ...
            {"method": "DELETE", "path": "/persohub/admin/persohub-events/{slug}"},
            {"method": "PUT", "path": "/persohub/admin/persohub-events/{slug}/status"},
            {"method": "PUT", "path": "/persohub/admin/persohub-events/{slug}/registration"},
            ...
            {"method": "GET", "path": "/persohub/admin/persohub-events/{slug}/logs"},
            {"method": "GET", "path": "/persohub/persohub-events/ongoing"},
            {"method": "GET", "path": "/persohub/persohub-events/all"},
