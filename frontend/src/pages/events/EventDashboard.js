...
export default function EventDashboard() {
    ...
    const leaveTeam = async () => {
        ...
        try {
            await axios.delete(`${API}/pda/events/${eventSlug}/team/leave`, { headers: getAuthHeader() });
    ...
    const removeMemberFromTeam = async () => {
        ...
        try {
            await axios.delete(`${API}/pda/events/${eventSlug}/team/members/${removeMemberDialog.userId}`, { headers: getAuthHeader() });
    ...
    const deleteTeam = async () => {
        ...
        try {
            await axios.delete(`${API}/pda/events/${eventSlug}/team`, { headers: getAuthHeader() });
