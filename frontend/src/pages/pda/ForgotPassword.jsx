...
export default function ForgotPassword() {
    ...
    const cooldownSeconds = Number(import.meta.env.VITE_EMAIL_RESEND_COOLDOWN_SECONDS || 30);
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-md border-2 border-black shadow-neo rounded-3xl p-8 bg-white">
                    ...
                    <p className="text-center mt-6">
                        <Link to="/login" className="font-semibold text-[#b8890b] hover:underline">Back to login</Link>
                    </p>
                </div>
            </div>
        </div>
