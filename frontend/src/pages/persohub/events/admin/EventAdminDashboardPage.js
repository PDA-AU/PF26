...
function DashboardContent() {
    ...
    const handleOpenEventQr = async () => {
        ...
        try {
            const url = `${window.location.origin}/persohub/events/${encodeURIComponent(slug)}`;
            ...
            {eventInfo?.participant_mode === 'individual' ? (
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="neo-card">
                        ...
                        <div className="space-y-3">
                            ...
                            <Button onClick={handleOpenEventQr} variant="outline" className="w-full border-2 border-black shadow-neo justify-start text-xs sm:text-sm">
                                <QrCode className="w-4 h-4 mr-2" /> {eventQrLoading ? 'Generating QR...' : 'View Event QR'}
                            </Button>
                        </div>
                    </div>
                ...
                <div className="neo-card mb-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                        ...
                        <Button onClick={handleOpenEventQr} variant="outline" className="border-2 border-black shadow-neo justify-start">
                            <QrCode className="w-4 h-4 mr-2" /> {eventQrLoading ? 'Generating QR...' : 'View Event QR'}
                        </Button>
                    </div>
                </div>
