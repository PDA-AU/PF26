...
function ScoringContent() {
    ...
    const fetchRoundData = useCallback(async () => {
        ...
        try {
            const [roundRes, rowsRes] = await Promise.all([
                axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds`, { headers: getAuthHeader() }),
                axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/participants`, {
            ...
            if (currentRound) {
                try {
                    const panelRes = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/panels`, {
                        headers: getAuthHeader(),
                    });
    ...
    const savePanelDefinitions = async (options = {}) => {
        ...
        setPanelSaving(true);
        try {
            const response = await axios.put(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/panels`, {
                panels: normalized,
            }, { headers: getAuthHeader() });
    ...
    const autoAssignPanels = async () => {
        ...
        try {
            const response = await axios.post(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/panels/auto-assign`, {
    ...
    const savePanelAssignments = async (options = {}) => {
        ...
        try {
            await axios.put(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/panels/assignments`, {
                assignments: changed,
            }, { headers: getAuthHeader() });
    ...
    const sendPanelEmails = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/panels/email`, payload, {
                headers: getAuthHeader(),
            });
    ...
    const saveScores = async (options = {}) => {
        ...
        try {
            ...
            await axios.post(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/scores`, payload, {
                headers: getAuthHeader(),
            });
            pushSavedUndo({
    ...
    const downloadTemplate = async () => {
        try {
            const response = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/score-template`, {
                headers: getAuthHeader(),
                responseType: 'blob',
            });
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            const response = await axios.post(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/import-scores`, formData, {
    ...
    const exportRoundEvaluation = async () => {
        ...
        try {
            const response = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/export/round/${roundId}?format=xlsx`, {
                headers: getAuthHeader(),
                responseType: 'blob',
            });
            const url = window.URL.createObjectURL(new Blob([response.data]));
    ...
    const exportRoundEvaluationCsv = async () => {
        ...
        try {
            const response = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/export/round/${roundId}?format=csv`, {
                headers: getAuthHeader(),
                responseType: 'blob',
            });
            const url = window.URL.createObjectURL(new Blob([response.data]));
    ...
    const exportRoundEvaluationPanelWise = async () => {
        ...
        try {
            const response = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/export/round/${roundId}/panel-wise?format=xlsx`, {
                headers: getAuthHeader(),
                responseType: 'blob',
            });
            const url = window.URL.createObjectURL(new Blob([response.data]));
    ...
    const freezeRound = async () => {
        try {
            await axios.post(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/freeze`, {}, { headers: getAuthHeader() });
            pushSavedUndo({
    ...
    const unfreezeRound = async () => {
        try {
            await axios.post(`${API}/persohub/admin/persohub-events/${eventSlug}/rounds/${roundId}/unfreeze`, {}, { headers: getAuthHeader() });
            pushSavedUndo({
