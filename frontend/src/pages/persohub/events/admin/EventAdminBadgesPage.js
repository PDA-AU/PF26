...
function BadgesContent() {
    ...
    const fetchBadges = useCallback(async () => {
        const response = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/badges`, {
    ...
    const fetchEntities = useCallback(async () => {
        const response = await axios.get(`${API}/persohub/admin/persohub-events/${eventSlug}/participants?page_size=200`, {
            headers: getAuthHeader(),
        });
